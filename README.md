...
Typical usage:
Script in it's own unique folder (many of my scripts will create sub-folders and look for config files in the same relative path)
File name of config.xml placed in the same folder as the script.
